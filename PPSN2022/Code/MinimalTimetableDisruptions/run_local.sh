...
#!/bin/bash
EXPERIMENTS_FILE=$1
JAR_CPLEX_PATH=/opt/ibm/ILOG/CPLEX_Studio_Community201/cplex/lib/cplex.jar
JAR_GSON_PATH=/home/smartebuses1/jars/gson-2.6.2.jar
CPLEX_PATH=/opt/ibm/ILOG/CPLEX_Studio_Community201/cplex/bin/x86-64_linux/
