...
void Ubcsat::HelpPrintAlgorithms() {
  UINT32 j;
...
void Ubcsat::HelpPrintAlgorithmsW() {
  UINT32 j;
...
void Ubcsat::SetHelpStringAlg(ALGORITHM *pAlg) {
...
void Ubcsat::SetHelpStringRep(REPORT *pRep) {
...
void Ubcsat::PrintUBCSATHeader(REPORT *pRep) {
...
void Ubcsat::HelpPrintReport(REPORT *pRep) {
  UINT32 j;
  UINT32 k;
  char *pCur;
  char *pNext;
...
void Ubcsat::HelpPrintAlgorithm(ALGORITHM *pAlg, BOOL bTerse, BOOL bVerbose) {
  UINT32 j;
...
void Ubcsat::HelpPrintParameter(ALGPARM *pCurParm, BOOL bAlgOffset) {
...
void Ubcsat::HelpPrintParameters(ALGPARMLIST *pParmList) {
...
void Ubcsat::HelpPrintParametersTerse(ALGPARMLIST *pParmList) {
...
void Ubcsat::HelpPrintParametersTerse2(ALGPARMLIST *pParmList) {
...
void Ubcsat::HelpPrintAlgParameters(ALGORITHM *pCurAlg) {
...
void Ubcsat::HelpPrintAlgParametersTerse(ALGORITHM *pCurAlg) {
...
void Ubcsat::HelpPrintSpecialParameters() {
...
void Ubcsat::HelpPrintSpecialParametersTerse() {
...
void Ubcsat::HelpBadParm(char *sParm) {
  PrintUBCSATHeader(pRepErr);
  ReportPrint(pRepErr,"\n");
  ReportPrint(pRepErr,"FATAL ERROR ENCOUNTERED: \n");
...
void Ubcsat::HelpBadReport(char *sParm) {
  PrintUBCSATHeader(pRepErr);
  ReportPrint(pRepErr,"\n");
  ReportPrint(pRepErr,"FATAL ERROR ENCOUNTERED: \n");
