...
void Ubcsat::AddAdaptNoveltyPlus() {
...
void Ubcsat::InitAdaptNoveltyNoise() {
...
void Ubcsat::AdaptNoveltyNoiseAdjust() {
...
void Ubcsat::AdaptNoveltyNoiseW() {
