...
//#define RunProceduresALEJO2(A) {if (aNumActiveProcedures[A]) {for (iRunProceduresLoop2=0;iRunProceduresLoop2<aNumActiveProcedures[A];iRunProceduresLoop2++) (*this.*aActiveProcedures[A][iRunProceduresLoop2])();} }

#define RunProceduresALEJO(A) {if (aNumActiveProcedures[A]) {for (iRunProceduresLoop=0;iRunProceduresLoop<aNumActiveProcedures[A];iRunProceduresLoop++) (*this.*aActiveProcedures[A][iRunProceduresLoop])();} }
#define RunProceduresALEJO2(A) {if (aNumActiveProcedures[A]) {for (iRunProceduresLoop2=0;iRunProceduresLoop2<aNumActiveProcedures[A];iRunProceduresLoop2++) (*this.*aActiveProcedures[A][iRunProceduresLoop2])();} }

#define RunProceduresALEJOclass(A, ubcsat) {if (ubcsat->aNumActiveProcedures[A]) {for (ubcsat->iRunProceduresLoop=0;ubcsat->iRunProceduresLoop<ubcsat->aNumActiveProcedures[A];ubcsat->iRunProceduresLoop++) (*ubcsat.*ubcsat->aActiveProcedures[A][ubcsat->iRunProceduresLoop])();} }
