...
void Ubcsat::InitLookAhead() {
  memset(aIsLookAhead,0,(iNumVars+1) * sizeof(UINT32));
}

SINT32 Ubcsat::BestLookAheadScore(UINT32 iLookVar) {
  UINT32 j;
  UINT32 k;
  UINT32 *pClause;
  UINT32 iVar;
