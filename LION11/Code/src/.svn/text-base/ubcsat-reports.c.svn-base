...
void Ubcsat::ReportOutSetup() {
  iNumOutputColumns = 0;
  ParseItemList(&listColumns,(char *)pRepOut->aParameters[0],&Ubcsat::ActivateColumnID);
  ParseItemList(&listColumns,(char *)pRepOut->aParameters[0],&Ubcsat::AddOutputColumnID);
}

void Ubcsat::ReportOutSplash() {
...
void Ubcsat::PrintColHeaders(REPORT *pRep,UINT32 iNumCols, UINT32 *aCols) {
...
void Ubcsat::PrintRow(REPORT *pRep, UINT32 iRow, UINT32 iNumCols, UINT32 *aCols) {
...
void Ubcsat::ReportStatsSetup() {
  ParseItemList(&listStats,(char *)pRepStats->aParameters[0],&Ubcsat::ActivateStatID);
}

FLOAT Ubcsat::GetRowElement(REPORTCOL *pCol,UINT32 iRowRequested, BOOL bSorted, BOOL bSortByStep) {
...
void Ubcsat::ReportRTDSetup() {
  iNumRTDColumns = 0;
  ParseItemList(&listColumns,(char *)pRepRTD->aParameters[0],&Ubcsat::ActivateColumnID);
  ParseItemList(&listColumns,(char *)pRepRTD->aParameters[0],&Ubcsat::AddRTDColumnID);
}

void Ubcsat::PrintRTDRow(UINT32 iRow) {
  PrintRow(pRepRTD,aSortedByStepsAndFound[iRow],iNumRTDColumns,aRTDColumns);
}

void Ubcsat::ReportRTDPrint() {
  UINT32 j;
...
void Ubcsat::ReportCNFStatsPrint() {
...
void Ubcsat::ReportBestSolPrint() {
  UINT32 j;
  if (iRun==1) {
...
void Ubcsat::ReportBestStepPrint() {
...
void Ubcsat::ReportTrajBestLMPostStep() {
...
void Ubcsat::ReportTrajBestLMPostRun() {
...
void Ubcsat::ReportSolutionPrint() {
  UINT32 j;
  if (iRun==1) {
...
void Ubcsat::ReportUniqueSolPrint() {
  UINT32 j;
  if (iRun==1) {
...
void Ubcsat::ReportUnsatClausesPrint() {
  UINT32 j;
  if (iRun==1) {
...
void Ubcsat::ReportFalseHistPrint() {
  UINT32 j;
  if (iRun==1) {
...
void Ubcsat::ReportDistancePrint() {
  UINT32 bLocalMin = FALSE;
  UINT32 bPrint;
  if ((iRun==1)&&(iStep==1)) {
...
void Ubcsat::ReportDistHistPrint() {
  UINT32 j;
  if (iRun==1) {
...
void Ubcsat::ReportFlipCountsPrint() {
  UINT32 j;
  if (iRun==1) {
...
void Ubcsat::ReportBiasCountsPrint() {
  UINT32 j;
  if (iRun==1) {
...
void Ubcsat::ReportUnsatCountsPrint() {
  UINT32 j;
  if (iRun==1) {
...
void Ubcsat::ReportVarLastPrint() {
  UINT32 j;
  if (iRun==1) {
...
void Ubcsat::ReportClauseLastPrint() {
  UINT32 j;
  if (iRun==1) {
...
void Ubcsat::ReportPenaltyCreate() {
...
void Ubcsat::ReportPenaltyPrintStep() {
  UINT32 j;
...
void Ubcsat::ReportPenaltyPrintRun() {
...
void Ubcsat::ReportPenMeanPrint() {
  UINT32 j;
  FLOAT fMean;
  FLOAT fStddev;
  FLOAT fCV;
...
void Ubcsat::ReportPenStddevPrint() {
  UINT32 j;
  FLOAT fMean;
  FLOAT fStddev;
  FLOAT fCV;
...
void Ubcsat::ReportMobilityPrint() {
...
void Ubcsat::ReportMobFixedPrint() {
...
void Ubcsat::ReportMobFixedFreqPrint() {
...
void Ubcsat::ReportAutoCorrPrint() {
...
*/
void Ubcsat::ReportTriggersPrint() {
...
void Ubcsat::ReportSatCompetitionPrint() {
  UINT32 j;
...
void Ubcsat::ActivateStepsFoundColumns() {
...
void Ubcsat::ColumnRunCalculation() {
...
void Ubcsat::ColumnStepCalculation() {
...
void Ubcsat::InitMobilityColumnN() {
  bMobilityColNActive = TRUE;
}

/***** Trigger InitMobilityColumnX *****/

void Ubcsat::InitMobilityColumnX() {
  bMobilityColXActive = TRUE;
}

void Ubcsat::UpdateMobilityColumn() {
...
/*int ( * CompareFun ) ( const void *, const void * )  (Ubcsat ubc_var) {
	return &ubc_var.compareSortedUnit;
}*/

int Ubcsat::CompareSortedUInt(const void *a, const void *b) {
  UINT32 a1,b1;
...
int Ubcsat::CompareSortedSInt(const void *a, const void *b) {
  return (asiSortColData[*(UINT32 *)a] - asiSortColData[*(UINT32 *)b]);
}

int Ubcsat::CompareSortedFloat(const void *a, const void *b) {
  FLOAT fCompare;
...
void Ubcsat::SortByCurrentColData(REPORTCOL *pCol) {
  ...
  if (pSortCol->eFinalDataType == DTypeUInt) {
    ...
    //qsortG((void *)aSortedByCurrent,iRun,sizeof(UINT32),this.CompareSortedUInt);
	qsortG((void *)aSortedByCurrent,iRun,sizeof(UINT32),&Ubcsat::CompareSortedUInt, this);
  } else if (pSortCol->eFinalDataType == DTypeSInt) {
    asiSortColData = pSortCol->psiColumnData;
    qsortG((void *)aSortedByCurrent,iRun,sizeof(UINT32),&Ubcsat::CompareSortedSInt, this);
  } else {
    afSortColData = pSortCol->pfColumnData;
    qsortG((void *)aSortedByCurrent,iRun,sizeof(UINT32),&Ubcsat::CompareSortedFloat, this);
  }

}

int Ubcsat::CompareFoundSortedUInt(const void *a, const void *b) {
  UINT32 a1,b1;
...
int Ubcsat::CompareFoundSortedSInt(const void *a, const void *b) {
  if (aFoundData[*(UINT32 *)a] != aFoundData[*(UINT32 *)b]) {
    if (aFoundData[*(UINT32 *)a]) {
      return(-1);
    } else {
...
int Ubcsat::CompareFoundSortedFloat(const void *a, const void *b) {
  FLOAT fCompare;
  if (aFoundData[*(UINT32 *)a] != aFoundData[*(UINT32 *)b]) {
    if (aFoundData[*(UINT32 *)a]) {
      return(-1);
...
void Ubcsat::SortByCurrentColDataAndFound(REPORTCOL *pCol) {
  ...
  if (pSortCol->eFinalDataType == DTypeUInt) {
    auiSortColData = pSortCol->puiColumnData;
    qsortG((void *)aSortedByCurrent,iRun,sizeof(UINT32),&Ubcsat::CompareFoundSortedUInt, this);
  } else if (pSortCol->eFinalDataType == DTypeSInt) {
    asiSortColData = pSortCol->psiColumnData;
    qsortG((void *)aSortedByCurrent,iRun,sizeof(UINT32),&Ubcsat::CompareFoundSortedSInt,this);
  } else {
    afSortColData = pSortCol->pfColumnData;
    qsortG((void *)aSortedByCurrent,iRun,sizeof(UINT32),&Ubcsat::CompareFoundSortedFloat, this);
  }

}

void Ubcsat::SortByStepPerformance() {
