...
void Ubcsat::PostFlipSAPSWSmooth() {
  if (iFlipCandidate) {
    return;
  }
...
void Ubcsat::InitRSAPS() {
  iLastAdaptStep=0;
  iLastAdaptNumFalse=iNumFalse;
  iRPs = iPs;
}

void Ubcsat::RSAPSAdaptSmooth() {
