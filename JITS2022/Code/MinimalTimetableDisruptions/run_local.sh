#!/bin/bash
EXPERIMENTS_FILE=$1
JAR_CPLEX_PATH=/opt/ibm/ILOG/CPLEX_Studio221/cplex/lib/cplex.jar
JAR_GSON_PATH=$PWD/jars/gson-2.6.2.jar
CPLEX_PATH=/opt/ibm/ILOG/CPLEX_Studio221/cplex/bin/x86-64_linux/
