...
public class ModelMTD {
	...
	/**
	 * 	The outputs only of the variables that determines the locations of the chargers
	 */
	HashMap<Integer, Double> stationOutputs;
...
public double solveModel() {
	...
	*/
	...
	public void writeOutput(boolean solved, int iter) throws UnknownObjectException, IloException {
		...
		*/
		...
		if (solved) {
			...
			stationOutputs = new HashMap<Integer, Double>();
