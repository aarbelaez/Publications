...
public class ResilientTimeOverlappingOnlyPerStopModelExtension extends OverlappingModelExtension {
	...
	public ResilientTimeOverlappingOnlyPerStopModelExtension(OverlappingOnlyPerStopVariablesSet overlappingVariablesSet,
	...
	public void addConstraintsPerStop(int b, int d, int k, int m, int i, int j) throws IloException {
		...
		sameStationSameTimeConstraint1.addTerm(1.0, backupRouteVariablesSet.arrivalTime[b][k]);
		...
		sameStationSameTimeConstraint2.addTerm(-1.0, backupRouteVariablesSet.arrivalTime[b][k]);
		sameStationSameTimeConstraint2.addTerm(-1.0, backupRouteVariablesSet.ct[b][k]);
		//sameStationSameTimeConstraint2.addTerm(-1 * instance.SM, backupRouteVariablesSet.xBStop[b][k]);
